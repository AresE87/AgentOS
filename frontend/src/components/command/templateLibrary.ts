...
export const missionTemplates: MissionTemplateDefinition[] = [
  {
    ...
    description: 'Research competitors, structure findings, and write the executive brief.',
    promptLabel: 'Which market or competitors?',
  ...
  },
  {
    ...
    description: 'Review code quality, verify security, and propose coverage improvements.',
    promptLabel: 'Which file or directory?',
  ...
  },
  {
    ...
    description: 'Research the topic, optimize for SEO, then draft and polish content.',
    promptLabel: 'What topic should we cover?',
  ...
  },
  {
    id: 'due_diligence',
    title: 'Due Diligence',
    description: 'Gather company, financial, and contract context into one diligence report.',
    promptLabel: 'Which company?',
  ...
  },
  {
    ...
    description: 'Research audience, write variants, then prepare the send-ready sequence.',
    promptLabel: 'Which product and audience?',
  ...
  },
  {
    id: 'design_sprint',
    title: 'Design Sprint',
    description: 'Research UX friction, design a concept, ship UI, and verify quality.',
    promptLabel: 'Which UX problem?',
