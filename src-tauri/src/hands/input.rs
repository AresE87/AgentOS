...
use windows::Win32::UI::Input::KeyboardAndMouse::{
    ...
    MOUSEEVENTF_RIGHTUP, MOUSEEVENTF_WHEEL, MOUSEINPUT, VIRTUAL_KEY, VK_CONTROL, VK_MENU,
    VK_RETURN, VK_SHIFT, VK_TAB, VK_ESCAPE, VK_BACK, VK_DELETE, VK_SPACE, VK_LEFT, VK_RIGHT,
    VK_UP, VK_DOWN, VK_HOME, VK_END, VkKeyScanW,
};
#[cfg(windows)]
