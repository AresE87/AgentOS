...
impl SpecialistRegistry {
    ...
    fn register_defaults(&mut self) {
        let defs = vec![
            ...
            // M8-4: Marketing specialist agents
            specialist(
                "social_media_director",
                "Social Media Director",
                SpecialistCategory::MarketingGrowth,
                AgentLevel::Senior,
                "Plans content calendars, decides what to post and when, optimizes for engagement across all platforms",
                "You are a Social Media Manager. Plan content calendars, decide what to post and when, optimize for engagement. Use the social_post tool to publish. Monitor performance with social_engagement.",
                &["social_post", "social_search", "social_engagement", "web_search", "bash"],
                "standard",
                "share-2",
            ),
            specialist(
                ...
                SpecialistCategory::MarketingGrowth,
                AgentLevel::Specialist,
                "Writes compelling social media posts adapted for each platform's format and audience",
                "You are a Content Writer specializing in social media. Write compelling posts adapted for each platform. Twitter: punchy hooks, max 270 chars. LinkedIn: professional, 150-300 words. Reddit: informative, not promotional.",
                &["social_post", "web_search", "web_browse", "read_file", "write_file"],
                "standard",
                "edit-3",
            ),
            specialist(
                ...
                SpecialistCategory::MarketingGrowth,
                AgentLevel::Specialist,
                "Monitors mentions and comments, replies promptly and helpfully, escalates negative feedback",
                "You are a Community Manager. Monitor mentions and comments, reply promptly and helpfully. Classify each mention (question/complaint/praise/spam). Escalate negative feedback to the user.",
                &["social_reply", "social_mentions", "social_search"],
                "standard",
                "message-circle",
            ),
            specialist(
                ...
                SpecialistCategory::MarketingGrowth,
                AgentLevel::Specialist,
                "Optimizes content for search engines, researches keywords, analyzes competitor content",
                "You are an SEO Specialist. Optimize content for search engines. Research keywords, suggest titles, add relevant hashtags. Analyze competitor content.",
                &["web_search", "web_browse", "social_search", "write_file"],
                "standard",
                "trending-up",
            ),
            specialist(
                ...
                SpecialistCategory::MarketingGrowth,
                AgentLevel::Specialist,
                "Tracks engagement metrics, identifies trends, reports on campaign performance with data-driven suggestions",
                "You are a Marketing Analyst. Track engagement metrics, identify trends, report on campaign performance. Suggest improvements based on data.",
                &["social_engagement", "social_search", "read_file", "write_file"],
                "standard",
                "activity",
            ),
        ];
