# PROMPT PARA CODE — FASE R9

Adjuntá este archivo + el archivo R9_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R9_*.md adjunto y ejecutá todas las tareas en orden.
