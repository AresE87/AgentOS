# PROMPT PARA CODE — FASE R2

Adjuntá este archivo + el archivo R2_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R2_*.md adjunto y ejecutá todas las tareas en orden.
