# PROMPT PARA CODE — FASE R10

Adjuntá este archivo + el archivo R10_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R10_*.md adjunto y ejecutá todas las tareas en orden.
