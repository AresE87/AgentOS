# PROMPT PARA CODE — FASE R6

Adjuntá este archivo + el archivo R6_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R6_*.md adjunto y ejecutá todas las tareas en orden.
