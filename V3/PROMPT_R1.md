# PROMPT PARA CODE — FASE R1

Adjuntá este archivo + el archivo R1_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R1_*.md adjunto y ejecutá todas las tareas en orden.
