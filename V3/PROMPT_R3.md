# PROMPT PARA CODE — FASE R3

Adjuntá este archivo + el archivo R3_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R3_*.md adjunto y ejecutá todas las tareas en orden.
