# PROMPT PARA CODE — FASE R7

Adjuntá este archivo + el archivo R7_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R7_*.md adjunto y ejecutá todas las tareas en orden.
