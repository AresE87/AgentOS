# PROMPT PARA CODE — FASE R8

Adjuntá este archivo + el archivo R8_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R8_*.md adjunto y ejecutá todas las tareas en orden.
