# PROMPT PARA CODE — FASE R5

Adjuntá este archivo + el archivo R5_*.md correspondiente + el código actual del proyecto.
...
Leé el archivo R5_*.md adjunto y ejecutá todas las tareas en orden.
